...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Eliminar cliente empresa</h1>
                </div><!-- /.col -->
            ...
            <div class="col-md-6">
                <div class="card card-danger">
                    <div class="card-header">
                        <h3 class="card-title">Esta seguro que desea eliminar a esta empresa como cliente?</h3>
                    ...
                    <div class="card-body" style="display: block;">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form action="../app/controllers/clientes/delete_clienteemp.php" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="razon-social" class="form-control" value="<?php echo $razon_social; ?>" disabled>
                                    </div>
