            ...
            <?php if ($rol_sesion == "Administrador") { ?>
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?php echo $URL ?>/usuarios" class="nav-link" style="background-color:orange">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Listado de Usuarios</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?php echo $URL ?>/usuarios/create.php" class="nav-link" style="background-color:orange">
                      <i class="far fa-circle nav-icon"></i>
