...
<script>
        fetch('http://localhost:3000/api/envios')
                ...
                data.forEach((proveedor, index) => {
                    const row = `
                        <tr>
                            ...
                            <td><a href="http://wa.me/+54${proveedor.celular}" target="_blank" class="btn btn-success">
                                <i class="fa fa-phone"></i> ${proveedor.celular}</a>
                            </td>
                            <td>${proveedor.telefono}</td>
                            <td>${proveedor.empresa}</td>
                            <td>${proveedor.cuit}</td>
                            <td>${proveedor.responsable_comercial}</td>
            ...
            .catch(error => console.error('Error al cargar los envios:', error));
    </script>
<!--Fin endpoint -->
