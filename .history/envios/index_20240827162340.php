                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" id="nombre_cliente${id_envio}" value="<?php echo $envios_datos['nombre'] . ' ' . $envios_datos['apellido']; ?>" class="form-control" disabled>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label>Fecha compra</label>
                                                                                        <input type="text" id="fecha${id_envio}" class="form-control" value="<?php echo $envios_datos['fyh_creacion']; ?>" disabled>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" id="direccion${id_envio}" class="form-control" value="<?php echo $envios_datos['Direccion']; ?>">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" id="precio${id_envio}" class="form-control" value="<?php echo '$' . $envios_datos['total_pagado']; ?>" disabled>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <select class="form-control" name="estado" id="estado${id_envio}" value="<?php echo $envios_datos['estado']; ?>">
