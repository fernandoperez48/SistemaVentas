...
$sql = "INSERT INTO tb_envios (IdVenta, IdCliente, Direccion, estado, FechaEnvio, descripcion) VALUES ('$codigo_venta', '$codcliente', '$direccion_envio', '$estado', '$fecha_envio', '$descripcion')";
