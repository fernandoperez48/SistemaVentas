...
$sql_envios ="SELECT e.IdVenta,COALESCE(emp.nombre, p.nombre) AS nombre, e.Direccion, e.estado,c.id_persona,v.total_pagado,v.nro_venta,v.fyh_creacion,d.calle
FROM tb_envios as e
