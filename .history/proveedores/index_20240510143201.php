                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" id="localidad<?php echo $id_proveedor; ?>" class="form-control" value="<?php echo $proveedores_datos['localidad']; ?>">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" id="domicilio<?php echo $id_proveedor; ?>" class="form-control" value="<?php echo $proveedores_datos['domicilio']; ?>">
