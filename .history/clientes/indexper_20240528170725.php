                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label>Piso </label>
                                                                                <input type="text" id="piso<?php echo $id_cliente; ?>" class="form-control" value="<?php echo $proveedores_datos['piso']; ?>">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label>Depto<b>*</b></label>
                                                                                <input type="text" id="depto<?php echo $id_cliente; ?>" class="form-control" value="<?php echo $proveedores_datos['depto']; ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
