                                    ...
                                    foreach ($clientesper_datos as $clientesper_datos) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    <div class="btn-group">
                                                        <a href="showper.php?id=<?php echo $id_cliente; ?>" type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#modal-ver<?php echo $id_cliente; ?>"><i class="fa fa-eye"></i>Ver</a>
