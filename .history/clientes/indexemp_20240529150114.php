                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" id="razon_social<?php echo $id_cliente; ?>" value="<?php echo $clientesemp_datos['apellido']; ?>" class="form-control">
                                                                                        <small style="color:red; display:none" id="lbl_apellidoE<?php echo $id_cliente; ?>">* Este campo es requerido</small>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" id="cuitE<?php echo $id_cliente; ?>" value="<?php echo $clientesemp_datos['dni']; ?>" class="form-control">
