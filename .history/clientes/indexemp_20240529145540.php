                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" id="apellido_clienteU<?php echo $id_cliente; ?>" value="<?php echo $clientesemp_datos['apellido']; ?>" class="form-control">
                                                                                ...
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        <label>Telefono</label>
                                                                                        <input type="number" id="telefonoU<?php echo $id_cliente; ?>" class="form-control" value="<?php echo $clientesemp_datos['telefono']; ?>">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        <label>DNI <b>*</b></label>
                                                                                        <input type="text" id="dniU<?php echo $id_cliente; ?>" value="<?php echo $clientesemp_datos['dni']; ?>" class="form-control">
                                                                                ...
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        <label>Email </label>
                                                                                        <input type="text" id="emailU<?php echo $id_cliente; ?>" class="form-control" value="<?php echo $clientesemp_datos['email']; ?>">
                                                                                ...
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" id="paisU<?php echo $id_cliente; ?>" class="form-control" value="<?php echo $clientesemp_datos['pais']; ?>">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" id="provinciaU<?php echo $id_cliente; ?>" class="form-control" value="<?php echo $clientesemp_datos['provincia']; ?>">
                                                                                ...
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        <label>Localidad </label>
                                                                                        <input type="text" id="localidadU<?php echo $id_cliente; ?>" class="form-control" value="<?php echo $clientesemp_datos['ciudad']; ?>">
                                                                                ...
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        <label>Domicilio<b>*</b></label>
                                                                                        <input type="text" id="domicilioU<?php echo $id_cliente; ?>" class="form-control" value="<?php echo $clientesemp_datos['calle']; ?>">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        <label>Nro<b>*</b></label>
                                                                                        <input type="text" id="numeroU<?php echo $id_cliente; ?>" class="form-control" value="<?php echo $clientesemp_datos['numero']; ?>">
                                                                                ...
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        <label>Piso </label>
                                                                                        <input type="text" id="pisoU<?php echo $id_cliente; ?>" class="form-control" value="<?php echo $clientesemp_datos['piso']; ?>">
                                                                                ...
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        <label>Depto<b>*</b></label>
                                                                                        <input type="text" id="deptoU<?php echo $id_cliente; ?>" class="form-control" value="<?php echo $clientesemp_datos['depto']; ?>">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
