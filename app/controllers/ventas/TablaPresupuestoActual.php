...
class TablaPresupuestoActual
{
    public static function render($contador_de_presupuestos, $mysqli)
    {
        ...
        <table class="table table-bordered table-sm table-hover table-striped">
            ...
            <tbody>
                ...
                $sql_carrito = "SELECT *,pro.nombre as nombre_producto, pro.descripcion as descripcion, 
                    ...
                    FROM tb_carrito_presupuesto as carr 
                    INNER JOIN tb_almacen as pro ON carr.id_producto = pro.id_producto 
                    WHERE nro_presupuesto = $contador_de_presupuestos + 1 
                    ORDER BY carr.id_detalle_presupuesto";
