...
$sql_insert_cliente_per = "INSERT INTO tb_personas(dni, nombre, apellido, telefono, email) 
                      VALUES ('$dni','$nombre', '$apellido', '$telefono', '$email')";
$resultado_cliente_per = $mysqli->query($sql_insert_cliente_per);

if ($resultado_cliente_per) {
    $id_persona = $mysqli->insert_id;

    // Inserción en tb_clientes
    $sql_clientes = "INSERT INTO tb_clientes(id_persona, condicion_iva) VALUES ('$id_persona', '$condicion_iva')";
