...
a.imagen as imagen, a.talle as talle, a.color as color, prov.nombre_proveedor as proveedor, cat.nombre_categoria as nombre_categoria, u.email as email, u.id_usuarios as id_usuario
...
if ($result) {
    ...
    $talle = $productos_datos['talle'];
    $color = $productos_datos['color'];
    ...
    $fecha_carga = $productos_datos['fecha_carga'];
    $fecha_ultimo_ingreso = $productos_datos['fecha_ultimo_ingreso'];
